...
const Card = ({ data }: any) => {
  ...
  return (
    <Link
      ...
      className="w-max h-max min-h-[6rem]  justify-center items-center min-w-[12rem] p-4 dark:bg-white bg-black  rounded-xl bg-opacity-10 flex flex-row gap-2 hover:bg-opacity-20"
    >
